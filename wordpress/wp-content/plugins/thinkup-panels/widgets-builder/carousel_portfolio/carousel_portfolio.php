...
if( ! class_exists( 'thinkup_builder_carouselportfolio' ) ) {

	class thinkup_builder_carouselportfolio extends WP_Widget {

		/* Register widget description. */
		function thinkup_builder_carouselportfolio() {
			$widget_ops = array('classname' => 'thinkup_builder_carouselportfolio', 'description' => 'Add a portfolio carousel to your content.' );
			parent::__construct('thinkup_builder_carouselportfolio', 'Portfolio (Carousel)', $widget_ops);
		}
		...
		function form($instance) {
			$default_entries = array( 
				...
				'link_icon'     => '', 
				'lightbox_icon' => '', 
				'toggle_title'  => '', 'toggle_details' => '', 'category' => '', );
		...
		function widget($args, $instance) {
			...
			echo do_shortcode( '[carousel_portfolio items="' . $items .'" scroll="' . $scroll . '" speed="' . $speed . '" effect="' . $effect . '" title="' . $toggle_title . '" details="' . $toggle_details . '" category="' . $category . '" link_icon="' . $link_icon . '" lightbox_icon="' . $lightbox_icon . '"]' );

		}
	}
	add_action( 'widgets_init', create_function('', 'return register_widget("thinkup_builder_carouselportfolio");') );
}
