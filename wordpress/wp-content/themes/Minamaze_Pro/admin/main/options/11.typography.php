...
global $thinkup_font_logoswitch;
global $thinkup_font_logogoogle;
...
global $thinkup_font_postfootergoogle;
	...
	$thinkup_font_logogoogle            =   str_replace( ' ', '+', $thinkup_font_logogoogle );
	...
	if ( $thinkup_font_bodyswitch == '1' or $thinkup_font_bodyheadingswitch == '1' or $thinkup_font_logoswitch or $thinkup_font_footerheadingswitch == '1' or $thinkup_font_preheaderswitch == '1' or $thinkup_font_mainheaderswitch == '1' or $thinkup_font_mainfooterswitch == '1' or $thinkup_font_postfooterswitch == '1' ) {
		echo 	"\n" . '<link href="//fonts.googleapis.com/css?family=';
			...
			if ( $thinkup_font_logoswitch == '1' and $thinkup_font_logogoogle !== 'Select+a+Google+Font' ) {
				echo $thinkup_font_logogoogle . ':300,400,600,700|';
			}
...
global $thinkup_font_bodyheadinggoogle;
global $thinkup_font_logoswitch;
global $thinkup_font_logostandard;
global $thinkup_font_logogoogle;
global $thinkup_font_preheaderswitch;
...
global $thinkup_font_postfootergoogle;
	...
	if ( ( empty( $thinkup_font_bodyswitch ) or $thinkup_font_bodyswitch == '0' ) and ! empty( $thinkup_font_bodystandard ) ) {
		if ( $thinkup_font_bodystandard == 'default theme font' ) {
			...
			$output .= '#section-home { font-family:' . $thinkup_font_bodystandard . '}' . "\n";
			$output .= '#slider .featured-excerpt, #slider .featured-link { font-family:' . $thinkup_font_bodystandard . '}' . "\n";
		}
		...
		if ( $thinkup_font_bodygoogle == 'Select a Google Font' ) {
			...
			$output .= '#section-home { font-family:' . $thinkup_font_bodygoogle . '}' . "\n";
			$output .= '#slider .featured-excerpt, #slider .featured-link { font-family:' . $thinkup_font_bodygoogle . '}' . "\n";
		}
	}
	if ( ( empty( $thinkup_font_bodyheadingswitch ) or $thinkup_font_bodyheadingswitch == '0' ) and ! empty( $thinkup_font_bodyheadingstandard ) ) {
		if ( $thinkup_font_bodyheadingstandard == 'default theme font' ) {
			...
			$output .= '#slider .featured-title { font-family:' . $thinkup_font_bodyheadingstandard . '}' . "\n";
		}
		...
		if ( $thinkup_font_bodyheadinggoogle == 'Select a Google Font' ) {
			...
			$output .= '#slider .featured-title { font-family:' . $thinkup_font_bodyheadinggoogle . '}' . "\n";
		}
	}
	if ( ( empty( $thinkup_font_logoswitch ) or $thinkup_font_logoswitch == '0' ) and ! empty( $thinkup_font_logostandard ) ) {
		if ( $thinkup_font_logostandard == 'default theme font' ) {
			$output .= '';
		} else {
			$output .= '#logo h1, #logo h2 { font-family:' . $thinkup_font_logostandard . '}' . "\n";
		}
	} else if ( $thinkup_font_logoswitch == '1' ) {
		if ( $thinkup_font_logogoogle == 'Select a Google Font' ) {
			$output .= '';
		} else {
			$output .= '#logo h1, #logo h2 { font-family:' . $thinkup_font_logogoogle . '}' . "\n";
		}
	}
