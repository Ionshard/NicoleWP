...
<option value=\"vimeo\">".__('Vimeo','thinkupshortcodes')."</option>
 ...
 <select style=\"display:none;\" class=\"thinkupshortcodes-elements-selector\" id=\"thinkupshortcodes-elements-selector-pricingtable\">				<option value=\"\"></option><option value=\"pricing2\">".__('Responsive','thinkupshortcodes')."</option>
<option value=\"pricing1\">".__('Fixed','thinkupshortcodes')."</option>
</select>
</span>
...
<option value=\"twittertweet\">".__('Twitter (tweet)','thinkupshortcodes')."</option>
 ...
 <select style=\"display:none;\" class=\"thinkupshortcodes-elements-selector\" id=\"thinkupshortcodes-elements-selector-tabs\">				<option value=\"\"></option><option value=\"tabs1\">".__('Style 1','thinkupshortcodes')."</option>
<option value=\"tabs2\">".__('Style 2','thinkupshortcodes')."</option>
</select>
</span>
		...
		foreach ($wp_query->posts as $key => &$post) {
			...
			if(!empty($shortcodes[2])){
				foreach($shortcodes[2] as $foundkey=>$shortcode){
					...
					wp_enqueue_script( 'google-plusonejs', 'https://apis.google.com/js/plusone.js', false , false, true );
					wp_enqueue_script( 'linkedin-injs', 'http://platform.linkedin.com/in.js', false , false, true );
					wp_enqueue_script( 'twitterfollow-widgetsjs', 'http://platform.twitter.com/widgets.js', false , false, true );
					wp_enqueue_script( 'twittertweet-widgetsjs', 'http://platform.twitter.com/widgets.js', false , false, true );
