...
$vimeoimage = unserialize(@file_get_contents('http://vimeo.com/api/v2/video/' . $id . '.php'));
...
echo	'<div class="sc-lightbox image">',
		...
		'<div class="hover-icons"><a class="hover-zoom prettyPhoto" href="https://vimeo.com/' . $id . '"' . $details_input . '><i></i></a></div>',
		'</div>',
		'</div>',
		'</div>';
} else {
