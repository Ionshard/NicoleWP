...
$youtubeimage = 'http://img.youtube.com/vi/' . $id . '/0.jpg';
...
echo	'<div class="sc-lightbox image">',
		...
		'<div class="hover-icons"><a class="hover-zoom prettyPhoto" href="http://www.youtube.com/watch?v=' . $id . '"' . $details_input . '"><i></i></a></div>',
		'</div>',
		'</div>',
		'</div>';
} else {
