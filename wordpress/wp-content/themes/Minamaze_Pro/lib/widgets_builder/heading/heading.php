...
class thinkup_builder_headingharest extends WP_Widget {

	/* Register widget description. */
	function thinkup_builder_headingharest() {
		$widget_ops = array('classname' => 'thinkup_builder_headingharest', 'description' => 'Add a heading to your content.' );
		parent::__construct('thinkup_builder_headingharest', 'Heading', $widget_ops);
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("thinkup_builder_headingharest");') );
