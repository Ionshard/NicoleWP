...
class thinkup_widget_tabs extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('postcount') . '">' . __( 'Number of posts', 'minamaze' ) . ': <input class="widefat" id="' . $this->get_field_id('postcount') . '" name="' . $this->get_field_name('postcount') . '" type="text" value="' . esc_attr($postcount) . '" style="width: 106px;margin-left: 20px;" /></label></p>';
	...
	global $post;
		...
		echo	'<ul class="nav nav-tabs">',
					'<li class="active"><a href="#widgetrecent-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Recent', 'minamaze' ) . '</h3></a></li>',
					'<li><a href="#widgetpopular-' . $current_instance_id . '" data-toggle="tab"><h3 class="widget-title">' . __( 'Popular', 'minamaze' ) . '</h3></a></li>',
				'</ul>';
